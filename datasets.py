...
def get_dataset(dataset_name, target_folder="./", datasets=DATASETS_CONFIG):
    ...
    if dataset_name == 'Houston13':
        ...
        label_queue = {"grass healthy": ['The grass healthy is lush'],
        ...
        label_queue = {"tree": ['The trees grow steadily along the road'],
        ...
        label_queue = {"Concrete/Asphalt": ['No crops on the surfaces of Concrete or Asphalt'],
...
class data_prefetcher():  # 异步加载和预取数据
